...
const GET_TASK_COMMENT = "http://localhost:9000/api/task/comments";
const ADD_COMMENT_ON_TASK = "http://localhost:9000/api/task/addComment/";
...
export class KanbanService {
  ...
  // getAllCommentOnTask(id: any): Observable<any | null> {
  //   return this.http.get(GET_TASK_COMMENT + "/" + id);
  // }
  // addCommentOnTask(comment: Comment, id: any): Observable<any | null> {
  //   return this.http.post(ADD_COMMENT_ON_TASK + "/" + id, comment, httpOptions);
  // }
}
