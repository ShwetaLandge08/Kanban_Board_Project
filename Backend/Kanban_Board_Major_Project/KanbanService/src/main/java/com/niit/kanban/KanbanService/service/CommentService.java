...
public interface CommentService {
    Project addCommentOnTask(Comment comment, int taskId, int projectId, String stageName) throws ProjectNotFoundException, CommentAlreadyExistsException, TaskNotFoundException;

    List<Comment> getAllCommentOnTask(int taskId, int projectId, String stageName) throws ProjectNotFoundException, TaskNotFoundException;
}
